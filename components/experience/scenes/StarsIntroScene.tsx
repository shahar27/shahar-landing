...
const starIdeas = [
  {
    ...
    text: "הכינו שמיים חשוכים מכל חומר יצירת שמתחשק לכם ושאפשר להדביק עליו כוכבים זוהרים בחושך (שווה לרכוש, במידה ואין). בכל קלף שהשלמתם, הדביקו על הבריסטול כוכב זוהר, כשהוא מתמלא אפשר למסגר ולתלות בחדר הילדים.",
  },
  {
    title: "צנצנת כוכבים",
