        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            {[
              ...
              "למה אני בטוח שהפעם אני אגיב אחרת, ושוב עושה בדיוק אותו דבר?",
              "אני מבינה שהילדים לא עושים לי בכוונה אז למה עדיין מתפוצצת עליהם, כשזו בכלל לא האמא שאני רוצה להיות?",
